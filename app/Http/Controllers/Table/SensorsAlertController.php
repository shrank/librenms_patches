...
class SensorsAlertController extends TableController
{
    ...
    protected function baseQuery(Request $request): Builder
    {
        ...
        $query = Sensor::query()
            ...
            ->leftJoin('sensors_to_state_indexes', 'sensors_to_state_indexes.sensor_id', '=', 'sensors.sensor_id')
        ...
        $where_error = '(sensor_current < sensor_limit_low OR sensor_current > sensor_limit OR state_translations.state_generic_value = 2)';
        $where_warning = '((sensor_current > sensor_limit_low AND sensor_current < sensor_limit AND (sensor_current < sensor_limit_low_warn OR sensor_current > sensor_limit_warn) OR state_translations.state_generic_value = 1))';
        ...
        switch($status) {
            ...
            case "error":
              $query->whereRaw($where_error);
              break;
            case "warning":
              $query->whereRaw($where_warning);
        }
        return $query;
    }
